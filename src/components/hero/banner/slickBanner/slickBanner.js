...
const SlickBanner = () => {
  ...
  return (
        <div>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="327" height="347" viewBox="0 0 327 347" fill="none">
                                        ...
                                        <foreignObject x="30" y="20" width="327" height="347">
                                                    ...
                                                    <h1 className='slickBanner__title'>Benefit of improving your business</h1>
                                                    <Slider {...settings}>

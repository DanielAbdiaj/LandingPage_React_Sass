...
const Footer = () => {
  return (
    ...
    <div className="footer__container">
            ...
            <div className="footer__dividerContainer"><div className='footer__divider'></div></div>
            ...
            <div className="footer__content">
                ...
                <div className="footer__content--linksContainer">
                    ...
                    <ul className="footer__ulist">
                        <li className="footer__list"><a href="" className="footer__link--title">Social Media</a></li>
